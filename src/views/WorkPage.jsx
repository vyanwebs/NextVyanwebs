...
const WorkPage = () => {
  ...
  return (
    <div>
      {/* Work Logo Black Section */}
      <div
        id="work-logo-black"
        className="relative h-[50vh] bg-gray-900 text-white flex flex-col justify-between px-6"
      >
        <h1
          ref={headingRef}
          className="
