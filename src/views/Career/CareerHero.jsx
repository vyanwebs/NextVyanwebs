...
const CareerHero = () => {
  ...
  return (
    <div className="relative min-h-[45vh] md:min-h-[50vh] bg-gray-900 text-white flex flex-col justify-between p-4 sm:p-8 md:p-12 lg:p-16 overflow-hidden">
      {/* Animated Heading */}
      <h1
        ref={headingRef}
        className="absolute 
      ...
      >
        Shape the Future: Join us and Make
        <br className="hidden md:inline" />
        Your Mark on the World
      </h2>

      <svg
        className="absolute bottom-6 right-6 opacity-20 w-48 h-48 sm:w-64 sm:h-64 md:w-72 md:h-72 lg:w-80 lg:h-80"
        viewBox="0 0 444 442"
        fill="none"
