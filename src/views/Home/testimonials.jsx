...
export default function TestimonialSlider() {
        ...
        gsap.fromTo(
          ...
          { opacity: 0, y: 30 },
          {
            ...
            scrollTrigger: {
              ...
              start: "top 90%",  // ← more lenient trigger point
  ...
  return (
    <div
      ref={sectionRef}
      style={{ opacity: 1 }} // ← fallback so it's never stuck invisible
                ...
                <div className="px-2 sm:px-4 md:px-6">
                  <div className="relative mx-auto px-4 sm:px-6 md:px-10 py-10 sm:py-14 lg:py-20">
                    ...
                    <div className="relative z-10 flex flex-col gap-6">
                      <p className="text-lg sm:text-xl md:text-2xl font-semibold leading-relaxed text-left">
                        {item.quote}
                      </p>

                      <div className="flex items-start text-left">
                        <div className="w-4 h-4 sm:w-6 sm:h-6 md:w-8 md:h-8 bg-blue-100 rounded-full mt-1 shrink-0" />
