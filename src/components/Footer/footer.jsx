...
import logo from "../../assets/svg.jpeg";
    ...
    <footer className="bg-[#13151d] text-white px-6 sm:px-10 lg:px-16 pt-16 pb-6">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
        ...
        <div>
          ...
          <div className="flex gap-4 text-lg sm:text-xl font-bold mt-8">
            ...
            <a
              href="https://www.instagram.com/vyanwebs"
              target="_blank"
              rel="noopener noreferrer"
            ...
            <a
              href="https://twitter.com/vyanwebs"
              target="_blank"
              rel="noopener noreferrer"
            ...
            <a
              href="https://www.linkedin.com/company/vyanwebs"
              target="_blank"
              rel="noopener noreferrer"
        ...
        {/* Services */}
        <div>
          <h4 className="mb-4 sm:mb-6 font-bold text-base tracking-wide">
            S E R V I C E S
          </h4>
      ...
      <div className="border-t border-gray-500 mt-10 pt-4 text-xs sm:text-sm md:text-base flex flex-col md:flex-row justify-between items-center text-gray-300 text-center gap-4 md:gap-0">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-5">
          ...
          <span className="hidden sm:inline text-blue-500 font-extrabold text-w-12">
            •
          </span>
          <Link
            href="/contact/privacys"
            className="hover:text-blue-500 transition-colors"
          >
            Privacy Policy
          </Link>
